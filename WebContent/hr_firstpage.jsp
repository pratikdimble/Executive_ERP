...
<ul>
    <li><a href="display_emps.jsp">Employee Attendance</a></li>
  <li><a href="">Employee Incentives</a></li>
  <li><a href="display_emps_for_payment.jsp">Employee Pay Slip</a></li>
    <li class="dropdown">
    ...
    <a href="leaveapp?operation=link1">Employee Leave Application</a>
    </div>
  </li>
    <li><a href="">Customer Pay Slip</a></li>
    <li><a href="">Vendor Pay Slip</a></li>
