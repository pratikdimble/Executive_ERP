					...
					<div class="w3_agileits_main_grid w3l_main_grid">
						...
						<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								...
								<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								<label><font color="red">Quotation Details</font></label>
							</span>
						</div>
						<hr><br/>
						<div class="w3_agileits_main_grid w3l_main_grid">
...
<!-- 							&nbsp&nbsp<input formaction="purchase_neworder.jsp" type="submit" value="New Order" style="height: 40px; width: 152px"/> -->
						</div>
					</div>
...
var xmlhttp; 
			...
			xmlhttp.open("POST","select_purchase2.jsp?q="+str,true); 
		xmlhttp.send(); 
return;
}
