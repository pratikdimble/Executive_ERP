...
return; 
	...
	PreparedStatement stmt=null; 
		stmt=connection.prepareStatement("select vendorAddr from erp_VENDOR where vendorName LIKE ?"); 
			...
			ResultSet rs=null; 
				rs= stmt.executeQuery(); 
						...
						while(rs.next()){ 
%> 
<input type="text"  value="<%=rs.getString("vendorAddr")%>" name="addr" readonly style="width: 200px;"/> 
<% 
} 
%> 
							</span>
