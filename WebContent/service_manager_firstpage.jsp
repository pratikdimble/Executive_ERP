...
<html>
<title>Service Manager first page</title>
<head>
...
<ul>
    <li><a href="display_empassign_service_manager.jsp">Assign Service and Region</a></li>
  <li><a href="display_incentive_service_manager.jsp">Incentives Master</a></li>
    <li class="dropdown">
