...
<html>
<head>
<title>Sale Edit/Delete Quotation</title>
...
<!-- banner -->
	<div class="center-container">
		<div class="main">
			<h1 class="w3layouts_head">Sale Edit/Delete Quotation</h1>
...
<%-- 						<input style="color:red" type="hidden" name="custreq"  value="<%=custReq%>" readonly/>  --%>
						...
						<div class="w3_agileits_main_grid w3l_main_grid">
							<span class="agileits_grid">
								...
								<input style="color:red" style="width: 130px;" name="custname" type="text" value="<%=rs1.getString("custName")%>" readonly/>
							</span>
						</div>
