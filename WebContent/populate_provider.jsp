...
<div class="w3_agileits_main_grid w3l_main_grid" id="provider" >
			<span class="agileits_grid">
				<label>Service Provider</label>
				  <select name="provider" style="width: 143px; height: 40px" onchange="showSerCost(this.value,document.getElementById('sname').value);showNetCost(this.value,document.getElementById('sname').value);document.getElementById('seramt').style.display='block';document.getElementById('servicedata').style.display='block';showMySerCost();" >
