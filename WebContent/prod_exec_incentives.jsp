...
<head>
<title>Incentives Master Data</title>
<!-- metatags-->
	...
	%>
		...
		%>
			...
			<div class="w3l-user">
				...
				<input type="text" name="empname"  value="<%=ename%>" readonly="readonly" style="width: 150px; "/>
					
			</div><br/>
<!-- 		  -->
			<div class="w3l-mail">
				<label class="head">Product Name<span class="w3l-star"> * </span></label>
						<select  class="category2" id="prodname" name="pname" style="width: 143px; height: 30px" required="required" onchange="showState(this.value)">
	...
	<option value="<%=rs1.getString("NAME")%>"><%=rs1.getString("NAME")%></option>
		...
		%> </select>
			...
			<div class="clear"></div>
				<div class="w3l-num">
		<label class="head">Product Type<span class="w3l-star"> * </span></label>
			<div id="state">
				<input type="text" name="prodtype" required="required"/>
			</div>  
		</div>
	</div>
			<div class="clear"></div>
			<div class="w3l-sym">
				<label class="head">Target per Product<span class="w3l-star"> * </span></label>	
					<input  type="text" name="tarppro" placeholder="" required="" id="target"style="width: 150px; "/>
			</div>
			<div class="w3l-num">
			<label class="head">Incentive per Product<span class="w3l-star"> * </span></label>	
