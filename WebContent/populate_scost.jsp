...
String thisService = (String) session.getAttribute("servicename");
...
float cost=0;
	...
	ResultSet rs=null;
	stmt=connection.prepareStatement("select servicecost from erp_servicedata where name='"+thisService+"' and provider like ?");
		...
		%> 
			<input id="serCost"  type="text" name="sercost" value="<%=cost%>"  style="width: 130px;" >
				</span>
				<div class="clear"></div>
			</div>
	</body> 
