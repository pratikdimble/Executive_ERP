  ...
  <c:when test="${!empty listLeaveDTOs}">
   <tr>
    ...
    <c:forEach var="dto"  items="${listLeaveDTOs}">
     ...
     <tr>
     <h1 style="color:red">
      <td><input id="myRadio"  type="radio" name="choice" value="${dto.leaveId}" onclick="document.getElementById('myid').removeAttribute('disabled');document.getElementById('myreject').removeAttribute('disabled')">${dto.leaveId}</input></td>
   		 <td>${dto.empId}</td>
   		 <td>${dto.empName}</td>
